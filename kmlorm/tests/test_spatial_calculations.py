...
class TestSpatialCalculations:
    ...
    def test_known_distances_coordinate_objects(self, coord1, coord2, expected_km, tolerance):
    ...
    @pytest.mark.parametrize("coord1,coord2,expected_km,tolerance", KNOWN_DISTANCES)
    def test_known_distances_point_objects(self, coord1, coord2, expected_km, tolerance):
    ...
    @pytest.mark.parametrize("coord1,coord2,expected_km,tolerance", KNOWN_DISTANCES)
    def test_known_distances_placemark_objects(self, coord1, coord2, expected_km, tolerance):
    ...
    def test_midpoint_calculations(self):
    ...
    def test_convenience_methods_coordinate(self):
    ...
    def test_convenience_methods_point(self):
    ...
    def test_convenience_methods_placemark(self):
    ...
    def test_coordinate_tuple_support(self):
    ...
    def test_coordinate_list_support(self):
